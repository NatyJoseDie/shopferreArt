      ...
      <div className="container flex h-20 items-center">
        <Link href="/" className="mr-6 flex items-center space-x-1.5">
          ...
          <div className="flex flex-col">
            <span className="font-bold text-3xl text-primary leading-none">DF</span>
            <span className="text-[0.6rem] text-muted-foreground tracking-wider leading-none mt-0.5">FERREART</span>
          </div>
        </Link>
